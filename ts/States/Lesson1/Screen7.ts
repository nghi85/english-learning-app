...
export default class Lesson1Screen7 extends Phaser.State {
    public static Name: string = 'lesson1_screen7';
    public static pause: boolean = false;

    public name: string = Lesson1Screen7.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.emma = new Character(
          this.game, Images.L1_4_Emma, 433 * scale_size, 500 * scale_size, 830 * scale_size,
          Images.L1_4_Emmabox, 1008 * scale_size, 210 * scale_size, Sounds.Sound_2B, 8, 3, "Hello, I'm Emma", true, false, false, true
        );
