...
export default class Lesson1Screen21 extends Phaser.State {
    public static Name: string = 'lesson1_screen21';
    public static pause: boolean = false;

    public name: string = Lesson1Screen21.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Images.Background_L1_21);
