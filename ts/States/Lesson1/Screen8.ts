...
export default class Lesson1Screen8 extends Phaser.State {
    public static Name: string = 'lesson1_screen8';
    public static pause: boolean = false;

    public name: string = Lesson1Screen8.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.mike = new Character(
          this.game, Images.L1_8_Mike, 427 * scale_size, 492 * scale_size, 830 * scale_size,
          Images.L1_8_Mikebox, 1008 * scale_size, 210 * scale_size, Sounds.Sound_2B, 23, 3, "Hello, I'm Mike", true, false, false, true
        );
