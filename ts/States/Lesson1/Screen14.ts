...
export default class Lesson1Screen14 extends Phaser.State {
    public static Name: string = 'lesson1_screen14';
    public static pause: boolean = false;

    public name: string = Lesson1Screen14.Name;
    public game: IGame;

    private background: Phaser.Image;
    private presentation: Phaser.Image;

    private paper: Character;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Images.Background_L1_14);
        ...
        this.paper = new Character(
            this.game, Images.L1_14_Paper, 720 * scale_size, 390 * scale_size, null,
            Images.L1_14_Paperbox, 750 * scale_size, 180 * scale_size, Sounds.Sound_4A, 15.5, 2, 'Paper', true, false, false, false
        );
