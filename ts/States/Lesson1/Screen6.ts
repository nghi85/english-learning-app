...
export default class Lesson1Screen6 extends Phaser.State {
    public static Name: string = 'lesson1_screen6';
    public static pause: boolean = false;

    public name: string = Lesson1Screen6.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Images.Background_L1_6);
        this.presentation = this.game.add.image(0, 20, Images.Presentation_L1_6);
