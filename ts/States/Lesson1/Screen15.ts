...
export default class Lesson1Screen15 extends Phaser.State {
    public static Name: string = 'lesson1_screen15';
    public static pause: boolean = false;

    public name: string = Lesson1Screen15.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Images.Background_L1_15);
        ...
        this.paint = new Character(
            this.game, Images.L1_15_Paint, 720 * scale_size, 390 * scale_size, null,
            Images.L1_15_Paintbox, 750 * scale_size, 180 * scale_size, Sounds.Sound_4A, 29, 2, 'Paint', true, false, false, false
        );
