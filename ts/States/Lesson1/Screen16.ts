...
export default class Lesson1Screen16 extends Phaser.State {
    public static Name: string = 'lesson1_screen16';
    public static pause: boolean = false;

    public name: string = Lesson1Screen16.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.julie = new Character(
            this.game, Images.L1_16_Julie, 155 * scale_size, 525 * scale_size, 235 * scale_size,
            Images.L1_16_Scissorsbox, 355 * scale_size, 316 * scale_size, Sounds.Sound_4B, 16.5, 1, 'Crissors', true, false, false, false
        );

        this.glue = new RectanglePicture(this.game, Images.L1_16_Glue, 720 * scale_size, 384 * scale_size, 0, 'Glue', 'Crissors', 0);
        this.scissors = new RectanglePicture(this.game, Images.L1_16_Scissors, 720 * scale_size, 384 * scale_size, 56 * scale_size, 'Crissors', 'Crissors', 1);
        this.paper = new RectanglePicture(this.game, Images.L1_16_Paper, 720 * scale_size, 384 * scale_size, 56 * scale_size, 'Paper', 'Crissors', 2);
