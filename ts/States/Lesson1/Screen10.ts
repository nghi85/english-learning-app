...
export default class Lesson1Screen10 extends Phaser.State {
    public static Name: string = 'lesson1_screen10';
    public static pause: boolean = false;

    public name: string = Lesson1Screen10.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.danny = new Character(
            this.game, Images.L1_4_Danny, 460 * scale_size, 504 * scale_size, 830 * scale_size,
            Images.L1_4_Dannybox, 1008 * scale_size, 210 * scale_size, Sounds.Sound_2B, 13, 2.7, "Hi, I'm Danny", true, false, false, true
        );
