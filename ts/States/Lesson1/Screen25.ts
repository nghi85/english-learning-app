...
export default class Lesson1Screen25 extends Phaser.State {
    public static Name: string = 'lesson1_screen25';
    public static pause: boolean = false;

    public name: string = Lesson1Screen25.Name;
    public game: IGame;

    public julie: Character;
    public glue: ChooseAnswers;
    public paper: ChooseAnswers;
    public scissors: ChooseAnswers;
    ...
    public create(): void {
        ...
        this.julie = new Character(
            this.game, Images.L1_25_Julie, 260 * scale_size, 390 * scale_size, 260 * scale_size,
            Images.L1_22_Scissorspop, 360 * scale_size, 100 * scale_size, Sounds.Sound_5C, 19.5, 3, 'I have scissors', false, false, false, false
        );
        ...
        this.glue = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Glue', 'Scissors', 0
        );
        this.paper = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Paper', 'Scissors', 1
        );
        this.scissors = new ChooseAnswers(
            this.game, Images.L1_23_Scissors, Images.L1_23_Scissors_True, Images.L1_23_Scissors_False, 760 * scale_size, 720 * scale_size,
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Scissors', 'Scissors', 2
        );
