...
export default class Lesson1Screen23 extends Phaser.State {
    public static Name: string = 'lesson1_screen23';
    public static pause: boolean = false;

    public name: string = Lesson1Screen23.Name;
    public game: IGame;

    public emma: Character;
    ...
    public create(): void {
        ...
        this.emma = new Character(
            this.game, Images.L1_23_Emma, 260 * scale_size, 390 * scale_size, 260 * scale_size,
            Images.L1_22_Paperpop, 360 * scale_size, 100 * scale_size, Sounds.Sound_5C, 7.5, 2, 'I have paper', false, false, false, false
        );
        ...
        this.glue = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Glue', 'Paper', 0
        );
        this.paper = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Paper', 'Paper', 1
        );
        this.scissors = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Scissors', 'Paper', 2
        );
