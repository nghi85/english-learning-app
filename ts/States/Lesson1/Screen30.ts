...
export default class Lesson1Screen30 extends Phaser.State {
    public static Name: string = 'lesson1_screen30';
    public static pause: boolean = false;

    public name: string = Lesson1Screen30.Name;
    public game: IGame;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Images.Background_L1_30);
        this.presentation = this.game.add.image(0, 20, Images.Presentation_L1_30);
