...
export default class Lesson1Screen26 extends Phaser.State {
    public static Name: string = 'lesson1_screen26';
    public static pause: boolean = false;

    public name: string = Lesson1Screen26.Name;
    public game: IGame;

    public danny: Character;
    ...
    public create(): void {
        ...
        this.danny = new Character(
            this.game, Images.L1_26_Danny, 260 * scale_size, 390 * scale_size, 260 * scale_size,
            Images.L1_22_Gluepop, 360 * scale_size, 100 * scale_size, Sounds.Sound_5C, 13.5, 2, 'I have glue', false, false, false, false
        );
        ...
        this.paint = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Paint', 'Glue', 0
        );
        this.paper = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Paper', 'Glue', 1
        );
        this.glue = new ChooseAnswers(
            ...
            680 * scale_size, 345 * scale_size, 15 * scale_size, 'Glue', 'Glue', 2
        );
